...
class GroupConversationTimestampsEvent with _$GroupConversationTimestampsEvent {
  const factory GroupConversationTimestampsEvent.initialize(String userID) =
      _InitializeTimestamps;
  const factory GroupConversationTimestampsEvent.onData(
      Map<String, DateTime> timestamps) = _OnDataReceived;
