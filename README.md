...
- ```createGroupConversation```: Funktion, die eine Custom Logik für das Erstellen von Gruppenchats einführt. Ein gutes Beispiel hierfür findest du in [OAmN][oamn_project], da wir in dem Projekt die Gruppenchats über unser eigenes Backend erstellen wollten.
